    ...
    @Override public void start(Stage stage) throws Exception {
        ...
        vipCol.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Person, Boolean>, ObservableValue<Boolean>>() {
            ...
            @Override public ObservableValue<Boolean> call(
                    TableColumn.CellDataFeatures<Person, Boolean> param) {
        ...
        firstNameTreeCol.setCellValueFactory(new Callback<CellDataFeatures<Person, String>, ObservableValue<String>>() {
        ...
        lastNameTreeCol.setCellValueFactory(new Callback<CellDataFeatures<Person, String>, ObservableValue<String>>() {
        ...
        primaryMailCol.setCellValueFactory(new Callback<CellDataFeatures<Person, String>, ObservableValue<String>>() {
        ...
        vipTreeTableCol.setCellValueFactory(new Callback<CellDataFeatures<Person, Boolean>, ObservableValue<Boolean>>() {
